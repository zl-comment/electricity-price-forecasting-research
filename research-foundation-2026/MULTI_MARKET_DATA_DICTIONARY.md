...
两处连续缺口的处理规则：**整交割日剔除**，不插值。共同窗口含 332 个交割日（2025-10-01 至 2026-08-28），剔除 2025-11-22、11-23、11-24 与 2026-08-25 共 4 天后为 328 天，进入[执行计划](Q3_NEXT_STEP_EXECUTION_PLAN_2026-09-06.md)第 8.1 节的滚动前推协议。第 4.1 节的可见性核算覆盖 335 个交割日，是按各表实际末端 2026-08-31 计算的，与此处受结算表限制的共同窗口口径不同。
