...
ALIGNMENT = {
    ...
    "F15": ("original_integrated_energy_park_data_not_publicly_available", [relation("D01_DK1_MULTI_MARKET", "multi_task_method_transfer_only", "Shared-layer multi-task structure transfers; the paper couples heat and gas loads, not day-ahead versus aFRR market functions.")]),
    ...
    "M07": ("original_german_market_and_forecast_inputs_not_released", [relation("D01_DK1_MULTI_MARKET", "sequential_market_baseline_transfer", "Observed day-ahead, aFRR capacity and imbalance series carry the gate-closure sequence; the paper's German order-book inputs are absent.")]),
