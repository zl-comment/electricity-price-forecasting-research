...
本组与交叉区的 X14 共同说明：“联合优化能增加收益”与“按闸门分阶段随机决策”本身都已经不新。既有 DK1 实验显示概率场景相对点预测具有决策价值，但复杂依赖结构没有稳定优势，固定风险系数也没有稳定兑现名义尾部覆盖。本分支关注现有近邻工作尚未共同覆盖的路径：后改制 DK1 中新能源富余午间充电、晚峰 SOC 与上调交付，以及实际激活结算下的收益—交付权衡；相关工作边界见[论文规划](../../../research-foundation-2026/PAPER_PLAN.md)。M09--M11 用于解释市场设计和系统运行含义，不替代参与者层的决策基线。
