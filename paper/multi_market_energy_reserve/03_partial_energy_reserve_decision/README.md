...
本组与交叉区的 X14 共同说明：“联合优化能增加收益”与“按闸门分阶段随机决策”本身都已经不新；P1 的贡献只能来自按已实现未交付事件在线校准风险系数、闸门条件联合场景，以及后改制 DK1 上按实际结算的同协议比较，见[论文规划](../../../research-foundation-2026/PAPER_PLAN.md)第 6 节。
